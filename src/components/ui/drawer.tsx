...
const drawerContentVariants = cva('fixed z-50 flex h-auto flex-col border border-text/10 text-text bg-background', {
  variants: {
    direction: {
      right: 'ml-24 mt-20 right-0 rounded-l-[10px] inset-y-0',
